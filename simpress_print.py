...
def inserir_contagem_impressoras(dataframe):
    ...
    #print(dataframe)
    dataframe2 = repo.recuperarDadosImpressoras(dataframe)
    #print('-----------------------------------------------')
    ...
    # print(dataframe.sort_values(by='CONTADOR_PB'))
    # print(dataframe2.sort_values(by='CONTADOR_PB'))
...
payload = {
    ...
    'dateTimeEnd': '2023-12-13 02:00:00',
